...
class TestMaskedArrays (unittest.TestCase):
    ...
    def test_module_contents(self):
        ...
        'allequal', 'alltrue', 'amax', 'amin', 'anom', 'anomalies',
        'any', 'apply_along_axis', 'arange', 'arccos', 'arccosh',
        'arcsin', 'arcsinh', 'arctan', 'arctan2', 'arctanh', 'argmax',
        'argmin', 'argsort', 'around', 'array', 'asanyarray',
        'asarray', 'atleast_1d', 'atleast_2d', 'atleast_3d',
        'average', 'bitwise_and', 'bitwise_or', 'bitwise_xor',
        'bool_', 'ceil', 'choose', 'clip', 'column_stack',
        'common_fill_value', 'compress', 'compress_cols',
        'compress_rowcols', 'compress_rows', 'compressed',
        'concatenate', 'conjugate', 'copy', 'core', 'corrcoef', 'cos',
        'cosh', 'count', 'count_masked', 'cov', 'cumprod', 'cumsum',
        'default_fill_value', 'diag', 'diagflat', 'diagonal',
        'divide', 'dot', 'dstack', 'dump', 'dumps', 'ediff1d',
        'empty', 'empty_like', 'equal', 'exp', 'expand_dims',
        'extras', 'fabs', 'filled', 'fix_invalid',
        'flatnotmasked_contiguous', 'flatnotmasked_edges',
        'flatten_mask', 'flatten_structured_array', 'floor',
        'floor_divide', 'fmod', 'frombuffer', 'fromflex',
        ...
        'logical_xor', 'make_mask', 'make_mask_descr',
        'make_mask_none', 'mask_cols', 'mask_or', 'mask_rowcols',
        'mask_rows', 'masked', 'masked_all', 'masked_all_like',
        'masked_array', 'masked_equal', 'masked_greater',
        'masked_greater_equal', 'masked_inside', 'masked_invalid',
        'masked_less', 'masked_less_equal', 'masked_not_equal',
        'masked_object', 'masked_outside', 'masked_print_option',
        'masked_singleton', 'masked_values', 'masked_where', 'max',
        'maximum', 'maximum_fill_value', 'mean', 'median', 'min',
        'minimum', 'minimum_fill_value', 'mod', 'mr_', 'multiply',
